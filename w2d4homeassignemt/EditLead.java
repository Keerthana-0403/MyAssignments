...
public class EditLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='createLeadForm_lastName']")).sendKeys("Nadar");
		driver.findElement(By.xpath("//input[@id='createLeadForm_firstNameLocal']")).sendKeys("Keerthi");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("keerthurajini@gmail.com");
